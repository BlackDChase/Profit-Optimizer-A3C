...
echo "Path is : $p"
python3 main.py -n=$n -e=$e -t=$t -a=$a -alr=$alr -clr=$clr -d=$d -p=$p -f=$f || echo "Stopped In Between"
...
# Comment line 44 for training and testing user interrupt using ctrl + c after sometime  
